...
Secret username: "enteryourusername"
/

b- Run below command in terminal:

ansible-vault encrypt bigip_pass.yml
New Vault Password: 
Confirm New Vault password:

Now if you cat bigip_pass.yml, you will see encrypted file
...
ansible-playbook bigipbackup.yml --ask-vault-pass

ii- Store the vault password in file and tell ansible where that file is
ansible-playbook bigipbackup.yml --vault-password-file /vault.pass.txt
...
Decrypt file: ansible-vault decrypt bigip_pass.yml // will prompt you to put vault password
Rekey: ansible-vault rekey bigip_pass.yml 
...
Mention the vault file that has password within playbook as "  vars_files: bigip_pass.yml"
...
Command to run to take backups: ansible-playbook /home/ansible/BIGIP/bigip_backup.yml -i /home/ansible/BIGIP/variable_files/hosts --vault-password-file /home/ansible/BIGIP/.vault.pass.txt
